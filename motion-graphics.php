...
<title>Get a great video made for great results.</title>
...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>Get a great video made for great results.</i></span>
    ...
    <div class="col-lg-6 height-dog aniSlide">
        <div class="fullwrap">
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <li class="current" data-targetit="tabs-motiongraphics">Motion Graphics</li>
...
?>
   ...
   <section class="next-page">
          <div class="next-page-wrap">
              <a href="<?php echo $path;?>seo" class="next-page__link">
                  <div class="next-page__desc">Next stop</div>
                  <div class="next-page__title">SEO</div>
