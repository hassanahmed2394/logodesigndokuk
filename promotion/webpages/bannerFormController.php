...
else{ $sql = 'insert into bannerFormQuery (cust_name,cust_email,cust_phonenumber,cust_message,PageURL ) values ("'.$_REQUEST['Name'].'","'.$_REQUEST['Email'].'","'.$_REQUEST['Number'].'","'.$_REQUEST['Message'].'","'.$_REQUEST['locationURL'].'")';
