...
$body .= "Package Selected: ".$_REQUEST['oPackage']." \n";
$body .= "NDA Status: ".$_REQUEST['NDA']." \n";
...
else{ $sql = 'insert into orderForm (cust_name,cust_number,cust_email,  package_detail, project_detail,attachment_URL) 
  values ("'.$_REQUEST['Name'].'","'.$_REQUEST['Number'].'","'.$_REQUEST['Email'].'","'.$_REQUEST['oPackage'].'","'.$_REQUEST['Comment'].'","'.$_REQUEST['wordfile'].'")';
