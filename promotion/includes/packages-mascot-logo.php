<div  id="pricing-2" class="owl-carousel owl-theme pl-2 pr-2">
<div class="item">
          <div class="package-box text-center">
                         <!-- <div class="productSku" style="display: none;">LOGO_OLIVE_PLATINUM</div> -->
                         <h4 class="category">Mascot Bronzde Logo <br> Package</h4>
                         <span class="actual-price packgePrice">$480.00</span><span class="sale-price">$299.00</span>
                         <div class="scroll">
...
<div class="item">
          <div class="package-box text-center">
                         ...
                         <span class="actual-price packgePrice">$550.00</span><span class="sale-price">$349.00</span>
                         <div class="scroll">
                            <ul style="margin-bottom: 18px;">
...
<div class="item">
          <div class="package-box text-center">
                         ...
                         <span class="actual-price packgePrice">$750.00</span><span class="sale-price">$549.00 </span>
                         <div class="scroll">
                            <ul style="margin-bottom: 18px;">
