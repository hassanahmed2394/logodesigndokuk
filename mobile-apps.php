...
<title>All products, just a tap away!</title>
...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <span><i>All products, just a tap away!</i></span>
  ...
  <div class="container">
    ...
    <div class="col-md-12">
      <ul>
        ...
        <li>
          <span>Let’s Envision and <br>Build together.</span>
    ...
    <section class="applications">
        <div class="app-container"> 
            ...
            <div class="tab-custom">
                ...
                <div class="tabs tabs-logodesign current row m-app-slider no-gutters for-works-load loadmoremob">
                    <?php
